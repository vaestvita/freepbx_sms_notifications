...
$dstchannel = $argv[4]; //${CDR(dstchannel)} - operator number from the module follow me where the call was made 
$dialstatus = $argv[3]; //${DIALSTATUS}  - result of the last Asterisk cmd Dial attempt
$src = $argv[2]; //${CALLERID(num)} - Caller ID Number only
$ext = $argv[1]; //${CONNECTEDLINE(num)} - Gets Connected Line data on the channel
